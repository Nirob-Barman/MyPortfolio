        ...
        <div id="About" className="py-12">
            <AnimatedSection className="bg-white rounded-lg shadow-lg p-8">
                ...
                <p className="mb-4 text-gray-700 leading-relaxed">
                    ...
                    IMSS Specialist Engineer at <span className="font-semibold">SoftifyBD</span>, where I build and maintain
                ...
                <p className="mb-4 text-gray-700 leading-relaxed">
                    My backend work includes designing multi-tenant ASP.NET Core APIs, building microservice modules with
                ...
                <p className="mb-4 text-gray-700 leading-relaxed">
                    Outside of work, I build full-stack projects applying Clean Architecture, the Repository / Unit of Work pattern,
